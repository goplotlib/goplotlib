...
func main() {
	...
	// @nodoc
	fig.SaveSVG("docs/static/img/line_basic.svg")
	// @doc
}
```
...
func main() {
	...
	// @nodoc
	fig.SaveSVG("docs/static/img/line_smooth_fill.svg")
	// @doc
}
```
...
func main() {
	...
	// @nodoc
	fig.SaveSVG("docs/static/img/line_dashed.svg")
	// @doc
}
```
...
```go run:line_straight_markers.svg
package main
...
func main() {
	...
	// @nodoc
	fig.SaveSVG("docs/static/img/line_straight_markers.svg")
	// @doc
}
```
